...
import { createNoteButtonClicked } from "./acrion-creators";

export const actionHandlers = {
  [CREATE_NOTE_BUTTON_CLICKED]: (state: typeof initialState, action: ReturnType<typeof createNoteButtonClicked>) => {
    return {
      ...state,
      notes: [
        ...state.notes,
